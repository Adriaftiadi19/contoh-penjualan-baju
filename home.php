				...
				<div class="carousel-inner" role="listbox">
					<div class="carousel-item active">
						<div class="carousel-caption text-center">
							<h3>Model Baju Pria
								<span>Mendapatkan diskon 50%</span>
							</h3>
					...
					<div class="carousel-item item2">
						<div class="carousel-caption text-center">
							<h3>Model Baju Wanita
								<span>Dapatkan barang dengan kualitas terbaik</span>
							</h3>
							<a href="?page=produk" class="btn btn-sm animated-button gibson-three mt-4">Beli Sekarang</a>
	...
	<section class="banner-bottom-wthreelayouts py-lg-5 py-3">
		<div class="container-fluid">
			<div class="inner-sec-shop px-lg-4 px-3">
				<h3 class="tittle-w3layouts my-lg-4 my-4">Barang Terlaris</h3>
				<div class="row">
					<!-- /womens -->
					<?php
                        $barang = mysqli_query($koneksi,"SELECT * FROM barang a left join ka b on a.id_kategori=b.id_kategori ORDER BY id_barang LIMIT 4");
                        $no=1;
								...
								<div class="men-thumb-item">
									...
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="<?= $base_url ?>/detail_produk<?php  echo $data['id_barang']  ?>" class="link-product-add-cart">Quick View</a>
										</div>
									</div>
